 ...
 * @author dongyinsheng
 */
public class MessageSinceLastRetrieve extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<ul>");
            out.println("<li><a href=\"http://localhost:8080/JQuery/#home\" data-icon=\"home\" data-transition=\"flow\">Home</a></li>");
            out.println("<li><a href=\"http://localhost:8080/JQuery/#addMessage\" data-icon=\"bullets\" data-transition=\"flow\">Add Message</a></li>");
            out.println("<li><a href=\"http://localhost:8080/350A4/MessageAll\" data-icon=\"bullets\" data-transition=\"flow\">All messages</a></li>");
            out.println("<li><a href=\"http://localhost:8080/350A4/MessageSinceLastRetrieve\" class=\"ui-btn-active ui-state-persist\" data-icon=\"bullets\" data-transition=\"flow\">New Message Since Last Retrieve</a></li>");
    ...
    private void changeTBP(ArrayList<MessagePost> toBePosted){
        ...
        List<Message> temp = allmessages.getAllMessages().subList(i, allmessages.getAllMessages().size());
         for ( Message ms : temp){
            boolean found = false;
        ...
        i = allmessages.getAllMessages().size();
    }

 ...
 * @author dongyinsheng
 */
public class MessageByID extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<MessagePost> toBeReturned = filterLists(toBePosted, request);
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            for ( MessagePost tbp : toBeReturned){
    ...
    private ArrayList<MessagePost> filterLists(ArrayList<MessagePost> toBePosted, HttpServletRequest request){
        ArrayList<MessagePost> toBeReturned = new ArrayList();
            String [] arr = request.getParameter("Message").split("\\s+");
            for (MessagePost mtbp : toBePosted){

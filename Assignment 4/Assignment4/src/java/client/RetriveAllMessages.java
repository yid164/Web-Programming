 ...
 * @author duke
 */
@WebServlet(name = "RetriveAllMessages", urlPatterns = {"/RetriveAllMessages"})
public class RetriveAllMessages extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<li><a href=\"http://localhost:8080/Assignment4/RetriveAllMessages\" data-icon=\"arrow-r\" class=\"ui-btn-active ui-state-persist\" data-transition=\"flow\">All messages</a></li>");
